...
<head>
  ...
  <title>PERPUS SDIT ANNIMAH</title>
  <!-- plugins:css -->
...
<body>
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center" style="background-color: #4c3c3c">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center" style="background-color: #4c3c3c">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background-color: #4c3c3c">
      @section('sidebar')
      ...
      <div class="main-panel">
        ...
        <footer class="footer">
          <div class="container-fluid clearfix">
            ...
            <a href="#" target="_blank">Herzi</a>. All rights reserved.</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
