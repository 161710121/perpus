                      ...
                      <h4 class="card-title">Tambah Transaksi baru</h4>
                        ...
                        <div class="form-group{{ $errors->has('kode_transaksi') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('tgl_pinjam') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input id="tgl_pinjam" type="date" class="form-control" name="tgl_pinjam" value="{{ date('Y-m-d', strtotime(Carbon\Carbon::today()->toDateString())) }}" required readonly @if(Auth::user()->level == 'user') readonly @endif>
                         ...
                         <div class="form-group{{ $errors->has('tgl_kembali') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input id="tgl_kembali" type="date"  class="form-control" name="tgl_kembali" value="{{ date('Y-m-d', strtotime(Carbon\Carbon::today()->addDays(3)->toDateString())) }}" required="" readonly="" @if(Auth::user()->level == 'user') readonly @endif>
                        ...
                        <div class="form-group{{ $errors->has('anggota_id') ? ' has-error' : '' }}">
                            <label for="anggota_id" class="col-md-4 control-label">Siswa</label>
                            <div class="col-md-6">
                                <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-warning btn-secondary" data-toggle="modal" data-target="#myModal2"><b>Cari Siswa</b> <span class="fa fa-search"></span></button>
                                </span>
                                </div>
